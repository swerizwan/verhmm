...
class Dataset(data.Dataset):
    ...
    def __init__(self, data,subjects_dict,data_type="train"):
        ...
        Args:
            ...
            subjects_dict (dict): Dictionary containing subjects for different data types.
            data_type (str): Type of data (e.g., "train", "val", "test").
        """
        self.data = data
    ...
    def __getitem__(self, index):
        ...
        Returns:
            tuple: Tuple containing audio, vertice, template, one_hot, and file_name.
        """
...
def read_data(args):
    """
    Read audio and vertex data from files.

    Args:
        args (argparse.Namespace): Arguments passed from the command line.

    Returns:
        tuple: Tuple containing train, validation, and test data, and subjects dictionary.
    """
    print("Loading data...")
...
def get_dataloaders(args):
    ...
    Returns:
        dict: Dictionary containing train, validation, and test data loaders.
    """
    dataset = {}
